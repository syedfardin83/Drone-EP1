...
void loop() {
  ...
  motor_inputs[0] = (desiredThrottle-rate_outputs[0]-rate_outputs[1]+rate_outputs[2])*255;
  motor_inputs[1] = (desiredThrottle-rate_outputs[0]+rate_outputs[1]-rate_outputs[2])*255;
  motor_inputs[2] = (desiredThrottle+rate_outputs[0]+rate_outputs[1]+rate_outputs[2])*255;
  motor_inputs[3] = (desiredThrottle+rate_outputs[0]-rate_outputs[1]-rate_outputs[2])*255;
